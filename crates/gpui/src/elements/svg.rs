use std::{fs, hash::Hash, path::Path, sync::Arc};

use crate::{
    App, Asset, Bounds, Element, ElementHashing, GlobalElementId, InspectorElementId,
...
impl Element for Svg {
    ...
    fn content_hash(&self) -> u64 {
        <Self as ElementHashing>::hash_values(|hasher| {
            ...
            self.external_path.hash(hasher);
        })
    }
